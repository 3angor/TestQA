...
* Макеты
	Если Табличный документ "Result" равен макету "Закупки1" Тогда // шаблон проверки выгруженный из отчета
...
* При создании первоночальных настроек
	Если в таблице "List" нет строк Тогда
		| 'Контрагент'  |
		| 'Контрагент1' |	
		И я нажимаю на кнопку 'Создать' // Тестовые данные вручную не создавать, лучше через загрузку
* Разные				
